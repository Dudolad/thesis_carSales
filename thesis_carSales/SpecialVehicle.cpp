...
SpecialVehicle::SpecialVehicle(std::string brand, int year, float price, std::string equipment, std::string country, Date saleDate, std::string buyerFullName, std::string type, float weight, float length, float width, float height)
